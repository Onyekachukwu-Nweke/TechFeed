...
require 'includes/form_handlers/reg_handler.php';
...
<head>
    ...
    <title>Welcome to Tech Feed</title>
        ...
        <div class="login_box">
            ...
            <div id="second">
                <form action="register.php" method="POST">
                    ...
                    required>
                    <br/>
                    <?php if(in_array("Your first name must be between 2 and 255 characters<br>", $error_array)) echo "Your first name must be between 2 and 255 characters<br>"; ?>
                    ...
                    required>
                    <br/>
                    <?php if(in_array("Your last name must be between 2 and 255 characters<br>", $error_array)) echo "Your last name must be between 2 and 255 characters<br>"; ?>
                    ...
                    <?php 
                        ...
                        else if(in_array("Your password must be between 5 and 255 characters<br>", $error_array)){echo "Your password must be between 5 and 255 characters<br>";}  
